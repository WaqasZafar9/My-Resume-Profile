...
const educationData = [
  {
    ...
    description:
      "Currently in the last semester. Coursework includes Flutter development, MERN stack, and AI concepts.",
  },
];
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h1
            style={{ color: "#4caf50", fontSize: "22px", fontWeight: "bold" }}
          >
            M Waqas Zafar
          </h1>
        ...
        <motion.div
          ...
          style={{
            ...
            paddingBottom: "20px",
            gap: "20px", // Ensures spacing on smaller screens
          }}
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ fontSize: "15px", color: "#bbb" }}>
                Computer Science
              </p>
              <p
                style={{
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: "15px",
            justifyContent: "center", // Center-aligns on mobile
          }}
        >
          <a href="mailto:mwaqaszafar76@gmail.com" style={contactStyle}>
            <FaEnvelope /> mwaqaszafar76@gmail.com
          </a>
          <a href="https://github.com/WaqasZafar9" style={contactStyle}>
            <FaGithub /> Github
          </a>
          <a href="https://bit.ly/waqaszafar-linkedin" style={contactStyle}>
            <FaLinkedin /> LinkedIn
          </a>
          <a href="https://github.com/WaqasZafar9" style={contactStyle}>
        ...
        >
          ...
          >
            I'm <strong>M Waqas Zafar</strong>,
          </motion.p>
          ...
          >
            ...
            addition to technical skills, I have a background in event
            management and team collaboration through my roles in bootcamps and
            PR. I am committed to continuous learning and have earned
            certifications in AI, web development, and network security.
          </motion.p>
        </motion.div>
        {/* Skills Section */}
        <motion.div
